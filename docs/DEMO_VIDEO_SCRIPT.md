...
**1:10–1:50 · Dashboard.**
Point at KPI row, then the live alert feed: **"Paracetamol stock will run out in 3 days at PHC Wakad."** "No one queried anything — the model raised it."

**1:50–2:25 · Medicines + AI transfer.**
Open Medicines → Wakad. Red row, days-left column. Banner: **"Transfer 320 units of ORS from PHC Aundh."** Tap **Approve** — both stocks update. "That's a stock-out that will never happen."

**2:25–2:50 · Beds & doctors.**
Beds: **CHC Baner at 90%** with referral suggestion. Doctors: attendance below 60% flagged with irregular-pattern chips.

**2:50–3:20 · Forecast & reports.**
Forecasting page: depletion curve crossing zero; **"High patient load expected tomorrow"** surge bars. Reports: AI risk ranking auto-flags the weakest centres.
