...
// Navigation configuration for the PHC/CHC staff portal.
const NAV_ITEMS = [
  { key: "dashboard", href: "/phc", icon: Activity, label: "Dashboard" },
  { key: "reception", href: "/phc/reception", icon: Users, label: "Reception" },
  { key: "inventory", href: "/phc/inventory", icon: Pill, label: "Inventory" },
  { key: "beds", href: "/phc/beds", icon: BedDouble, label: "Beds" },
  { key: "lab", href: "/phc/lab", icon: FlaskConical, label: "Lab" },
  { key: "pharmacy", href: "/phc/pharmacy", icon: Pill, label: "Pharmacy" },
  { key: "attendance", href: "/phc/attendance", icon: Calendar, label: "Attendance" },
  { key: "settings", href: "/phc/settings", icon: Settings, label: "Settings" },
];
      ...
      <div className="border-t border-inherit p-3">
        <div className="flex items-center gap-2.5 rounded-xl p-2 bg-white/50 dark:bg-slate-800/50">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-[10px] text-slate-500 dark:text-slate-400">PHC Staff</p>
          </div>
        ...
        <header className="flex items-center gap-3 border-b bg-white/70 dark:bg-slate-900/70 px-4 py-3 sm:px-6 backdrop-blur-xl">
          ...
          <div className="min-w-0">
            <h1 className="truncate font-display text-base font-bold sm:text-lg text-slate-800 dark:text-slate-200">
              {NAV_ITEMS.find((n) => n.key === activeKey)?.label || "PHC Portal"}
            </h1>
          </div>
